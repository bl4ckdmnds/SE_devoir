...
if not __name__ == "__main__" :
    ...
    """
    tests.append(
        ("top95 = .4.7...6...39............57.......3.2...8.....19...57.6...4.....5.1......2...6.84",
        ['040700060','003900000','000000057','000000030','200080000','019000570','600040000','050100000','020006084'],
        ['040700060','003900000','000000057','000000030','200080000','019000570','600040005','050100000','020006084'],
        ['040700060','003900000','000000057','000000030','200080000','019000570','600040005','050100000','020006084'],
        ['842715963','573962841','196834257','768591432','235487196','419623578','687249315','354178629','921356784']))
    tests.append(
        ("top95 = 6..3.2....5.....1..........7.26............543.........8.15........4.2........7..",
        ['600302000','050000010','000000000','702600000','000000054','300000000','080150000','000040200','000000700'],
        ['600302500','050000012','020500000','742605000','000000054','305000027','280150000','000040200','000000700'],
        ['600302500','050000012','020500000','742605000','000000054','305000027','280150000','000040200','000000700'],
        ['614382579','953764812','827591436','742635198','168279354','395418627','286157943','579843261','431926785']))
    tests.append(
        ("top95 = 6.2.5.........3.4..........43...8....1....2........7..5..27...........81...6.....",
        ['602050000','000003040','000000000','430008000','010000200','000000700','500270000','000000081','000600000'],
        ['602050000','000003042','000002000','430028000','010000200','000000700','500270000','000000081','000680027'],
        ['602050000','000003042','000002000','430028000','010000200','000000700','500270000','000000081','000680027'],
        ['682154379','951763842','374892165','437528916','816937254','295416738','568271493','729345681','143689527']))
    tests.append(
        ("top95 = 6.2.5.........4.3..........43...8....1....2........7..5..27...........81...6.....",
        ['602050000','000004030','000000000','430008000','010000200','000000700','500270000','000000081','000600000'],
        ['602050000','000004032','000002000','430028000','010000200','000000700','500270000','000000081','000680027'],
        ['602050000','000004032','000002000','430028000','010000200','000000700','500270000','000000081','000680027'],
        ['682153479','951764832','374892165','437528916','816947253','295316748','568271394','729435681','143689527']))
    tests.append(
        ("top95 = .98.1....2......6.............3.2.5..84.........6.........4.8.93..5...........1..",
        ['098010000','200000060','000000000','000302050','084000000','000600000','000040809','300500000','000000100'],
        ['098010000','200000060','000000000','000302050','084000000','000604000','000040809','300500000','800000105'],
        ['098010000','200000060','000000000','000302050','084000000','000604000','000040809','300500000','800000105'],
        ['498716523','257839461','136425987','971382654','684157392','523694718','765241839','319578246','842963175']))
    """
    ...
    for test in tests :
        ...
        if test[3] is not None and not x.solved() :
            ...
            #x.check()
            assert x.as_test_list() == test[3], "One level supposition failed"

        if test[4] is not None and not x.solved() :
            x.two_level_supposition()
            #x.check()
            assert x.as_test_list() == test[4], "Two level supposition failed"
    ...
    for test_file in ["top95.txt","top91.txt","top100.txt","msk_009.txt","top870.txt"] :
        print "Running tests from %s" % test_file
